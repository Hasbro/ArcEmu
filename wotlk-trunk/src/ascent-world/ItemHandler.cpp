...
void WorldSession::HandleSwapItemOpcode(WorldPacket& recv_data)
{
	...
	{
		sLog.outDetail("ITEM: Moo 1");
		return;
	}
	
	if( ( SrcInvSlot <= 0 && SrcSlot < 0 ) || SrcInvSlot < -1 )
	{
		sLog.outDetail("ITEM: Moo 2");
		return;
	}
