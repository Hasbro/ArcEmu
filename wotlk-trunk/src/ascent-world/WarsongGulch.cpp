...
WarsongGulch::WarsongGulch(MapMgr * mgr, uint32 id, uint32 lgroup, uint32 t) : CBattleground(mgr, id, lgroup, t)
{
	...
	m_homeFlags[0]->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
	m_homeFlags[0]->SetByteValue(GAMEOBJECT_BYTES_1, 1, 24); //SetUInt32Value(GAMEOBJECT_TYPE_ID, 24);
	m_homeFlags[0]->SetByteValue(GAMEOBJECT_BYTES_1, 3, 100); //SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);

	// silverwing flag - alliance base
	m_homeFlags[1] = SpawnGameObject(179830, 489, 1540.29f, 1481.34f, 352.64f, 3.17301f, 0,1314, 2.5f);
	m_homeFlags[1]->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
	m_homeFlags[1]->SetByteValue(GAMEOBJECT_BYTES_1, 1, 24); //SetUInt32Value(GAMEOBJECT_TYPE_ID, 24);
	m_homeFlags[1]->SetByteValue(GAMEOBJECT_BYTES_1, 3, 100); //SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);
...
void WarsongGulch::SpawnBuff(uint32 x)
{
	...
	case 0:
		...
		m_buffs[x]->SetFloatValue(GAMEOBJECT_PARENTROTATION+2,0.73135370016098f);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_PARENTROTATION+3,-0.681998312473297f);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 1, 6); //SetUInt32Value(GAMEOBJECT_TYPE_ID, 6);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 3, 100); //SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);
		break;
	case 1:
		m_buffs[x] = SpawnGameObject(179899, 489, 1005.17071533203f, 1447.94567871094f, 335.903228759766f, 1.64060950279236f, 0, 114, 1);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_PARENTROTATION+2,0.73135370016098f);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_PARENTROTATION+3,0.681998372077942f);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 1, 6); //SetUInt32Value(GAMEOBJECT_TYPE_ID, 6);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 3, 100); //SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);
		break;
	case 2:
		...
		m_buffs[x]->SetFloatValue(GAMEOBJECT_PARENTROTATION+2,0.130526319146156f);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_PARENTROTATION+3,-0.991444826126099f);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 1, 6); //SetUInt32Value(GAMEOBJECT_TYPE_ID, 6);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 3, 100); //SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);
		break;
	case 3:
		...
		m_buffs[x]->SetFloatValue(GAMEOBJECT_PARENTROTATION+2,0.333806991577148f);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_PARENTROTATION+3,-0.94264143705368f);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 1, 6); //SetUInt32Value(GAMEOBJECT_TYPE_ID, 6);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 3, 100); //SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);
		break;
	case 4:
		...
		m_buffs[x]->SetFloatValue(GAMEOBJECT_PARENTROTATION+2,0.559192895889282f);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_PARENTROTATION+3,0.829037606716156f);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 1, 6); //SetUInt32Value(GAMEOBJECT_TYPE_ID, 6);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 3, 100); //SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);
		break;
	case 5:
		...
		m_buffs[x]->SetFloatValue(GAMEOBJECT_PARENTROTATION+2,0.939692616462708f);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_PARENTROTATION+3,-0.342020124197006f);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 1, 6); //SetUInt32Value(GAMEOBJECT_TYPE_ID, 6);
		m_buffs[x]->SetByteValue(GAMEOBJECT_BYTES_1, 3, 100); //SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);
		break;
...
void WarsongGulch::OnCreate()
{
	...
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION+1,-0.004956f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION+2,-0.283972f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION+3,0.9586736f);
	gate->PushToWorld(m_mapMgr);
	m_gates.push_back(gate);
	...
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION+1,0.1575096f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION+2,-0.8239487f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION+3,0.5073640f);
	gate->PushToWorld(m_mapMgr);
	m_gates.push_back(gate);
...
void WarsongGulch::OnStart()
{
	...
	for(list<GameObject*>::iterator itr = m_gates.begin(); itr != m_gates.end(); ++itr)
	{
		...
		(*itr)->SetByteValue(GAMEOBJECT_BYTES_1, 0, 0); //SetUInt32Value(GAMEOBJECT_STATE, 0);
		(*itr)->Despawn(5000);
	}
