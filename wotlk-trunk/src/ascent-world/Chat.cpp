...
void CommandTableStorage::Init()
{
	static ChatCommand modifyCommandTable[] =
	{
		...
		{ "runepower",	'm', NULL, "Rune Power",			NULL, UNIT_FIELD_POWER6, UNIT_FIELD_MAXPOWER6, 1 },
		{ "runicpower",	'm', NULL, "Runic Power",			NULL, UNIT_FIELD_POWER7, UNIT_FIELD_MAXPOWER7, 1 },
		{ "glyph1", 'm', NULL, "Glyph 1",			NULL, PLAYER_FIELD_GLYPHS_1 , 0, 1 }, // glpyh shit
		{ "glyph2", 'm', NULL, "Glyph 2",			NULL, PLAYER_FIELD_GLYPHS_2 , 0, 1 },
		{ "glyph3", 'm', NULL, "Glyph 3",			NULL, PLAYER_FIELD_GLYPHS_3 , 0, 1 },
		{ "glyph4", 'm', NULL, "Glyph 4",			NULL, PLAYER_FIELD_GLYPHS_4 , 0, 1 },
		{ "glyph5", 'm', NULL, "Glyph 5",			NULL, PLAYER_FIELD_GLYPHS_5 , 0, 1 },
		{ "glyph6", 'm', NULL, "Glyph 6",			NULL, PLAYER_FIELD_GLYPHS_6 , 0, 1 },
		{ "glyph7", 'm', NULL, "Glyph 7",			NULL, PLAYER_FIELD_GLYPHS_7 , 0, 1 },
		{ "glpyh8", 'm', NULL, "Glyph 8",			NULL, PLAYER_FIELD_GLYPHS_8 , 0, 1 }, // end glyph shit
		{ "rune1regen", 'm', NULL, "Rune 1 Regen",			NULL, PLAYER_RUNE_REGEN_1 , 0, 1 },
		{ "rune2regen", 'm', NULL, "Rune 2 Regen",			NULL, PLAYER_RUNE_REGEN_2 , 0, 1 },
		{ "rune3regen", 'm', NULL, "Rune 3 Regen",			NULL, PLAYER_RUNE_REGEN_3 , 0, 1 },
		{ "rune4regen", 'm', NULL, "Rune 4 Regen",			NULL, PLAYER_RUNE_REGEN_4 , 0, 1 },
	...
	static ChatCommand GameObjectCommandTable[] =
	{
		...
		{ "spawn",	   'z', &ChatHandler::HandleGOSpawn,	"Spawns a GameObject by ID",				NULL, 0, 0, 0},
	...
	static ChatCommand NPCCommandTable[] =
	{
		...
		{ "spawn", 'z', &ChatHandler::HandleCreatureSpawnCommand, ".npc spawn - Spawns npc of entry <id>", NULL, 0, 0, 0 },
...
bool ChatHandler::HandleGetPosCommand(const char* args, WorldSession *m_session)
{
	...
	if(se)
		BlueSystemMessage(m_session, "SpellIcon for %d is %d", se->m_id, se->m_spellIconID);
	return true;
}
