...
enum WeaponDamageType // this is NOT the same as SPELL_ENTRY_m_defenseType, or Spell::GetType(), or SPELL_ENTRY_School !!
{
	MELEE   = 0,
	OFFHAND = 1,
	RANGED  = 2,
...
enum HitStatus
{
	...
	HITSTATUS_UNK2			= 0x100,
	HITSTATUS_UNK3			= 0x2000,
