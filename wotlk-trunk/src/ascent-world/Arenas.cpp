...
void Arena::OnAddPlayer(Player * plr)
{
	...
	for(uint32 x=0;x<MAX_AURAS;x++)
	{
		if(plr->m_auras[x])
		{
			if(plr->m_auras[x] && !plr->m_auras[x]->GetSpellProto()->m_durationIndex && plr->m_auras[x]->GetSpellProto()->m_attributesExC & CAN_PERSIST_AND_CASTED_WHILE_DEAD)
				continue;
			else
			{
...
void Arena::OnCreate()
{
	...
	case 572: {
		...
		obj->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		obj->SetFloatValue(GAMEOBJECT_PARENTROTATION+2, 0.746058f);
		obj->SetFloatValue(GAMEOBJECT_PARENTROTATION+3, 0.665881f);
		m_gates.insert(obj);

		obj = SpawnGameObject(185918, 572, 1293.560791f, 1601.937988f, 31.605574f, -1.457349f, 32, 1375, 1.0f);
		obj->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		obj->SetFloatValue(GAMEOBJECT_PARENTROTATION+2, -0.665881f);
		obj->SetFloatValue(GAMEOBJECT_PARENTROTATION+3, 0.746058f);
		m_gates.insert(obj);
	...
	case 562: {
		...
		obj->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		obj->SetFloatValue(GAMEOBJECT_PARENTROTATION+2, 0.90445f);
		obj->SetFloatValue(GAMEOBJECT_PARENTROTATION+3, -0.426569f);
		obj->PushToWorld(m_mapMgr);

		obj = SpawnGameObject(183973, 562, 6189.546387f, 241.709854f, 3.101481f, 0.881392f, 32, 1375, 1.0f);
		obj->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		obj->SetFloatValue(GAMEOBJECT_PARENTROTATION+2, 0.426569f);
		obj->SetFloatValue(GAMEOBJECT_PARENTROTATION+3, 0.904455f);
		m_gates.insert(obj);
		...
		obj->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		obj->SetFloatValue(GAMEOBJECT_PARENTROTATION+2, 0.904455f);
		obj->SetFloatValue(GAMEOBJECT_PARENTROTATION+3, -0.426569f);
		m_gates.insert(obj);
			  }break;
	...
	case 559: {
		...
		obj->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		obj->SetFloatValue(GAMEOBJECT_PARENTROTATION+2, 0.243916f);
		obj->SetFloatValue(GAMEOBJECT_PARENTROTATION+3, 0.969796f);
		obj->PushToWorld(m_mapMgr);
		...
		obj->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		obj->SetFloatValue(GAMEOBJECT_PARENTROTATION+2, 0.969796f);
		obj->SetFloatValue(GAMEOBJECT_PARENTROTATION+3, -0.243916f);
		obj->PushToWorld(m_mapMgr);
