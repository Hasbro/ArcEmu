...
void ArathiBasin::SpawnBuff(uint32 x)
{
	...
	if(m_buffs[x] == NULL)
	{
		...
		m_buffs[x]->SetFloatValue(GAMEOBJECT_PARENTROTATION+2, BuffRotations[x][0]);
		m_buffs[x]->SetFloatValue(GAMEOBJECT_PARENTROTATION+3, BuffRotations[x][1]);
...
void ArathiBasin::SpawnControlPoint(uint32 Id, uint32 Type)
{
	...
	if(m_controlPoints[Id] == NULL)
	{
		...
		m_controlPoints[Id]->SetFloatValue(GAMEOBJECT_PARENTROTATION+2, ControlPointRotations[Id][0]);
		m_controlPoints[Id]->SetFloatValue(GAMEOBJECT_PARENTROTATION+3, ControlPointRotations[Id][1]);
		m_controlPoints[Id]->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		m_controlPoints[Id]->SetByteValue(GAMEOBJECT_BYTES_1, 1, gi->Type); //SetUInt32Value(GAMEOBJECT_TYPE_ID, gi->Type);
		m_controlPoints[Id]->SetByteValue(GAMEOBJECT_BYTES_1, 3, 100); //SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);
	...
	if(m_controlPointAuras[Id] == NULL)
	{
		...
		m_controlPointAuras[Id]->SetFloatValue(GAMEOBJECT_PARENTROTATION+2, ControlPointRotations[Id][0]);
		m_controlPointAuras[Id]->SetFloatValue(GAMEOBJECT_PARENTROTATION+3, ControlPointRotations[Id][1]);
		m_controlPointAuras[Id]->SetByteValue(GAMEOBJECT_BYTES_1, 0, 1); //SetUInt32Value(GAMEOBJECT_STATE, 1);
		m_controlPointAuras[Id]->SetByteValue(GAMEOBJECT_BYTES_1, 1, 6); //SetUInt32Value(GAMEOBJECT_TYPE_ID, 6);
		m_controlPointAuras[Id]->SetByteValue(GAMEOBJECT_BYTES_1, 3, 100);//SetUInt32Value(GAMEOBJECT_ANIMPROGRESS, 100);
...
void ArathiBasin::OnCreate()
{
	...
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION,0.0129570f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION+1,-0.0602880f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION+2,0.3449600f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION+3,0.9365900f);
	gate->PushToWorld(m_mapMgr);
	m_gates.push_back(gate);

	// horde gate
	gate = SpawnGameObject(180256, 529, 708.0902710f, 708.4479370f, -17.3898964f, -2.3910990f, 32, 114, 1.5699990f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION,0.0502910f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION+1,0.0151270f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION+2,0.9292169f);
	gate->SetFloatValue(GAMEOBJECT_PARENTROTATION+3,-0.3657840f);
	gate->PushToWorld(m_mapMgr);
	m_gates.push_back(gate);
