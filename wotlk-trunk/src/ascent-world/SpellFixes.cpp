...
void CreateDummySpell(uint32 id)
{
	...
	sp->m_id = id;
	sp->m_attributes = 384;
	sp->m_attributesEx = 268435456;
	sp->m_attributesExB = 4;
	sp->m_castingTimeIndex=1;
	sp->m_procChance=75;
	sp->m_rangeIndex=13;
	sp->m_equippedItemClass=uint32(-1);
	sp->m_effect[0]=3;
	sp->m_implicitTargetA[0]=25;
	sp->NameHash=crc32((const unsigned char*)name, (unsigned int)strlen(name));
	sp->m_effectChainAmplitude[0]=1.0f;
	sp->m_stanceBarOrder=-1;
...
void Apply112SpellFixes()
{
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 4294967295UL;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 100663310;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[1] = 4194437;
		sp->m_effectItemType[2] = 14686967;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 151264832;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 3999288558UL;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 160;
		sp->m_effectItemType[1] = 576;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 3758096384UL;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[1] = 33554432;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 16777825;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 41984000;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 1073741824UL;
		sp->m_effectItemType[1] = 2147483648UL;
	}

	// Spell 17778 Group Relation (Cataclysm Rank 1)
	sp = dbcSpell.LookupEntryForced(17778);
	if(sp != NULL) {
		sp->m_effectItemType[0] = 997;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 33792;
		sp->m_effectItemType[1] = 4194304;
	}

	// Spell 18427 Group Relation (Aggression Rank 1)
	sp = dbcSpell.LookupEntryForced(18427);
	if(sp != NULL) {
		sp->m_effectItemType[0] = 131074;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 139993232;
		sp->m_effectItemType[1] = 5775504;
		sp->m_effectItemType[2] = 10518528;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 268435456;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 134217728;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[1] = 536870912;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 2048;
		sp->m_effectItemType[1] = 2048;
		sp->m_effectItemType[2] = 2048;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 536870912;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 1073741824;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 67108864;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 128;
		sp->m_effectItemType[1] = 16;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 3221225472UL;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 1073741824;
		sp->m_effectItemType[1] = 1073741824;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[2] = 16777829;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[1] = 4026531840UL;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 268558336;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 16777216;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[1] = 138412544;
	}
	...
	if(sp != NULL) {
		sp->m_effectItemType[0] = 1152794256;
	}
...
void ApplyNormalFixes()
{
	...
	for(uint32 x=0; x < cnt; x++)
	{
		...
		float radius=std::max(::GetRadius(dbcSpellRadius.LookupEntry(sp->m_effectRadiusIndex[0])),::GetRadius(dbcSpellRadius.LookupEntry(sp->m_effectRadiusIndex[1])));
		radius=std::max(::GetRadius(dbcSpellRadius.LookupEntry(sp->m_effectRadiusIndex[2])),radius);
		radius=std::max(GetMaxRange(dbcSpellRange.LookupEntry(sp->m_rangeIndex)),radius);
...
#define SET_SCHOOL(x) sp->m_schoolMask = x
		if(sp->m_schoolMask & 1)
			SET_SCHOOL(SCHOOL_NORMAL);
		else if(sp->m_schoolMask & 2)
			SET_SCHOOL(SCHOOL_HOLY);
		else if(sp->m_schoolMask & 4)
			SET_SCHOOL(SCHOOL_FIRE);
		else if(sp->m_schoolMask & 8)
			SET_SCHOOL(SCHOOL_NATURE);
		else if(sp->m_schoolMask & 16)
			SET_SCHOOL(SCHOOL_FROST);
		else if(sp->m_schoolMask & 32)
			SET_SCHOOL(SCHOOL_SHADOW);
		else if(sp->m_schoolMask & 64)
			SET_SCHOOL(SCHOOL_ARCANE);
		else
			printf("UNKNOWN SCHOOL %u for spell %u (%s)\n", sp->m_schoolMask , sp->m_id , sp->m_name_lang[0] );
#undef SET_SCHOOL
		...
		*/
		...
		if( sp->m_casterAuraState != 0 )
		{
			switch( sp->m_casterAuraState )
			{
			case 1:
				sp->m_casterAuraState = AURASTATE_FLAG_DODGE_BLOCK;
				break;

			case 2:
				sp->m_casterAuraState = AURASTATE_FLAG_HEALTH20;
				break;

			case 3:
				sp->m_casterAuraState = AURASTATE_FLAG_BERSERK;
				break;

			case 5:
				sp->m_casterAuraState = AURASTATE_FLAG_JUDGEMENT;
				break;

			case 7:
				sp->m_casterAuraState = AURASTATE_FLAG_PARRY;
				break;

			case 10:
				sp->m_casterAuraState = AURASTATE_FLAG_LASTKILLWITHHONOR;
				break;

			case 11:
				sp->m_casterAuraState = AURASTATE_FLAG_CRITICAL;
				break;

			case 13:
				sp->m_casterAuraState = AURASTATE_FLAG_HEALTH35;
				break;

			case 14:
				sp->m_casterAuraState = AURASTATE_FLAG_IMMOLATE;
				break;

			case 15:
				sp->m_casterAuraState = AURASTATE_FLAG_REJUVENATE;
				break;

			case 16:
				sp->m_casterAuraState = AURASTATE_FLAG_POISON;
				break;

			default:
				Log.Error("AuraState", "Spell %u (%s) has unknown caster aura state %u\n", sp->m_id, sp->m_name_lang, sp->m_casterAuraState);
				break;
			}
		}

		if( sp->m_targetAuraState != 0 )
		{
			switch( sp->m_targetAuraState )
			{
			case 1:
				sp->m_targetAuraState = AURASTATE_FLAG_DODGE_BLOCK;
				break;

			case 2:
				sp->m_targetAuraState = AURASTATE_FLAG_HEALTH20;
				break;

			case 3:
				sp->m_targetAuraState = AURASTATE_FLAG_BERSERK;
				break;

			case 5:
				sp->m_targetAuraState = AURASTATE_FLAG_JUDGEMENT;
				break;

			case 7:
				sp->m_targetAuraState = AURASTATE_FLAG_PARRY;
				break;

			case 10:
				sp->m_targetAuraState = AURASTATE_FLAG_LASTKILLWITHHONOR;
				break;

			case 11:
				sp->m_targetAuraState = AURASTATE_FLAG_CRITICAL;
				break;

			case 13:
				sp->m_targetAuraState = AURASTATE_FLAG_HEALTH35;
				break;

			case 14:
				sp->m_targetAuraState = AURASTATE_FLAG_IMMOLATE;
				break;

			case 15:
				sp->m_targetAuraState = AURASTATE_FLAG_REJUVENATE;
				break;

			case 16:
				sp->m_targetAuraState = AURASTATE_FLAG_POISON;
				break;

			default:
				Log.Error("AuraState", "Spell %u (%s) has unknown target aura state %u\n", sp->m_id, sp->m_name_lang, sp->m_targetAuraState);
				break;
			}
		}
		...
		for( uint32 col1_swap = 0; col1_swap < 2 ; col1_swap++ )
			for( uint32 col2_swap = col1_swap ; col2_swap < 3 ; col2_swap++ )
				if( sp->m_effect[col1_swap] == SPELL_EFFECT_WEAPON_PERCENT_DAMAGE && sp->m_effect[col2_swap] == SPELL_EFFECT_DUMMYMELEE )
				{
					uint32 temp;
					float ftemp;
					temp = sp->m_effect[col1_swap];			sp->m_effect[col1_swap] = sp->m_effect[col2_swap] ;						sp->m_effect[col2_swap] = temp;
					temp = sp->m_effectDieSides[col1_swap];	sp->m_effectDieSides[col1_swap] = sp->m_effectDieSides[col2_swap] ;		sp->m_effectDieSides[col2_swap] = temp;
					temp = sp->m_effectBaseDice[col1_swap];	sp->m_effectBaseDice[col1_swap] = sp->m_effectBaseDice[col2_swap] ;		sp->m_effectBaseDice[col2_swap] = temp;
					ftemp = sp->m_effectDicePerLevel[col1_swap];			sp->m_effectDicePerLevel[col1_swap] = sp->m_effectDicePerLevel[col2_swap] ;				sp->m_effectDicePerLevel[col2_swap] = ftemp;
					ftemp = sp->m_effectRealPointsPerLevel[col1_swap];	sp->m_effectRealPointsPerLevel[col1_swap] = sp->m_effectRealPointsPerLevel[col2_swap] ;	sp->m_effectRealPointsPerLevel[col2_swap] = ftemp;
					temp = sp->m_effectBasePoints[col1_swap];	sp->m_effectBasePoints[col1_swap] = sp->m_effectBasePoints[col2_swap] ;	sp->m_effectBasePoints[col2_swap] = temp;
					temp = sp->m_effectMechanic[col1_swap];	sp->m_effectMechanic[col1_swap] = sp->m_effectMechanic[col2_swap] ;	sp->m_effectMechanic[col2_swap] = temp;
					temp = sp->m_implicitTargetA[col1_swap];	sp->m_implicitTargetA[col1_swap] = sp->m_implicitTargetA[col2_swap] ;	sp->m_implicitTargetA[col2_swap] = temp;
					temp = sp->m_implicitTargetB[col1_swap];	sp->m_implicitTargetB[col1_swap] = sp->m_implicitTargetB[col2_swap] ;	sp->m_implicitTargetB[col2_swap] = temp;
					temp = sp->m_effectRadiusIndex[col1_swap];	sp->m_effectRadiusIndex[col1_swap] = sp->m_effectRadiusIndex[col2_swap] ;	sp->m_effectRadiusIndex[col2_swap] = temp;
					temp = sp->m_effectAura[col1_swap];					sp->m_effectAura[col1_swap] = sp->m_effectAura[col2_swap] ;			sp->m_effectAura[col2_swap] = temp;
					temp = sp->m_effectAmplitude[col1_swap];		sp->m_effectAmplitude[col1_swap] = sp->m_effectAmplitude[col2_swap] ;	sp->m_effectAmplitude[col2_swap] = temp;
					ftemp = sp->m_effectMultiple[col1_swap];		sp->m_effectMultiple[col1_swap] = sp->m_effectMultiple[col2_swap] ;	sp->m_effectMultiple[col2_swap] = ftemp;
					temp = sp->m_effectChainTargets[col1_swap];	sp->m_effectChainTargets[col1_swap] = sp->m_effectChainTargets[col2_swap] ;	sp->m_effectChainTargets[col2_swap] = temp;
					temp = sp->m_effectItemType[col1_swap];	sp->m_effectItemType[col1_swap] = sp->m_effectItemType[col2_swap] ;	sp->m_effectItemType[col2_swap] = temp;
					temp = sp->m_effectMiscValue[col1_swap];		sp->m_effectMiscValue[col1_swap] = sp->m_effectMiscValue[col2_swap] ;	sp->m_effectMiscValue[col2_swap] = temp;
					temp = sp->m_effectTriggerSpell[col1_swap];	sp->m_effectTriggerSpell[col1_swap] = sp->m_effectTriggerSpell[col2_swap] ;	sp->m_effectTriggerSpell[col2_swap] = temp;
					ftemp = sp->m_effectPointsPerCombo[col1_swap];	sp->m_effectPointsPerCombo[col1_swap] = sp->m_effectPointsPerCombo[col2_swap] ;	sp->m_effectPointsPerCombo[col2_swap] = ftemp;
				}

		for(uint32 b=0;b<3;++b)
		{
			if(sp->m_effectTriggerSpell[b] != 0 && dbcSpell.LookupEntryForced(sp->m_effectTriggerSpell[b]) == NULL)
			{
				/* proc spell referencing non-existant spell. create a dummy spell for use w/ it. */
				CreateDummySpell(sp->m_effectTriggerSpell[b]);
			}
			/** Load teaching spells (used for hunters when learning pets wild abilities) */
			if(sp->m_effect[b]==SPELL_EFFECT_LEARN_SPELL && sp->m_implicitTargetA[b]==EFF_TARGET_PET)
			{
				map<uint32,uint32>::iterator itr = sWorld.TeachingSpellMap.find(sp->m_effectTriggerSpell[b]);
				if(itr == sWorld.TeachingSpellMap.end())
					sWorld.TeachingSpellMap.insert(make_pair(sp->m_effectTriggerSpell[b],sp->m_id));
			}

			if( sp->m_attributes & ATTRIBUTES_ONLY_OUTDOORS && sp->m_effectAura[b] == SPELL_AURA_MOUNTED )
			{
				sp->m_attributes &= ~ATTRIBUTES_ONLY_OUTDOORS;
			}

			// fill in more here
			/*switch( sp->m_implicitTargetA[b] )
			{
			case 1:
			case 9:
		...
		if(!strcmp(sp->m_name_lang[0], "Hearthstone") || !strcmp(sp->m_name_lang[0], "Stuck") || !strcmp(sp->m_name_lang[0], "Astral Recall"))
			sp->self_cast_only = true;
		...
		talentSpellIterator = talentSpells.find(sp->m_id);
		...
		if( namehash == SPELL_HASH_SEAL_OF_LIGHT )			
			sp->m_procChance = 45;	/* this will do */

		//seal of command
		else if( namehash == SPELL_HASH_SEAL_OF_COMMAND )		
			sp->m_defenseType = SPELL_DMG_TYPE_MAGIC;
		...
		if( strstr( nametext, "Crippling Poison") && sp->m_effect[0] == 54 ) //I, II
			sp->m_effectBasePoints[0] = 3599;
		if( strstr( nametext, "Mind-numbing Poison") && sp->m_effect[0] == 54 ) //I,II,III
			sp->m_effectBasePoints[0] = 3599;
		if( strstr( nametext, "Instant Poison") && sp->m_effect[0] == 54 ) //I,II,III,IV,V,VI,VII    
			sp->m_effectBasePoints[0] = 3599;
		if( strstr( nametext, "Deadly Poison") && sp->m_effect[0] == 54 ) //I,II,III,IV,V,VI,VII
			sp->m_effectBasePoints[0] = 3599;
		if( strstr( nametext, "Wound Poison") && sp->m_effect[0] == 54 ) //I,II,III,IV,V
			sp->m_effectBasePoints[0] = 3599;
		if( strstr( nametext, "Anesthetic Poison") && sp->m_effect[0] == 54 ) //I
			sp->m_effectBasePoints[0] = 3599;

        if( strstr( nametext, "Sharpen Blade") && sp->m_effect[0] == 54 ) //All BS stones
            sp->m_effectBasePoints[0] = 3599;
        ...
        if( strstr( nametext, "Seal"))
		{
			...
			All_Seal_Groups_Combined |= sp->m_spellClassMask;
		}
...
//            type |= SPELL_TYPE_WARLOCK_CURSES;
		...
		if(sp->m_spellLevel==0)
		{
			...
			{
				uint32 teachspell=0;
				if(sp->m_effect[0]==SPELL_EFFECT_LEARN_SPELL)
					teachspell = sp->m_effectTriggerSpell[0];
				else if(sp->m_effect[1]==SPELL_EFFECT_LEARN_SPELL)
					teachspell = sp->m_effectTriggerSpell[1];
				else if(sp->m_effect[2]==SPELL_EFFECT_LEARN_SPELL)
					teachspell = sp->m_effectTriggerSpell[2];
				if(teachspell)
				{
					SpellEntry *spellInfo;
					spellInfo = dbcSpell.LookupEntryForced(teachspell);
					spellInfo->m_spellLevel = new_level;
					sp->m_spellLevel = new_level;
				}
			}
		}
...
//			break;
		...
		if(!(sp->m_auraInterruptFlags & AURA_INTERRUPT_ON_ANY_DAMAGE_TAKEN))
		{
			for(uint32 z = 0; z < 3; ++z) {
				if(sp->m_effectAura[z] == SPELL_AURA_MOD_FEAR ||
					sp->m_effectAura[z] == SPELL_AURA_MOD_ROOT)
				{
					sp->m_auraInterruptFlags |= AURA_INTERRUPT_ON_UNUSED2;
					break;
				}

				if( ( sp->m_effect[z] == SPELL_EFFECT_SCHOOL_DAMAGE && sp->m_defenseType == SPELL_DMG_TYPE_MELEE ) || sp->m_effect[z] == SPELL_EFFECT_WEAPON_DAMAGE_NOSCHOOL || sp->m_effect[z] == SPELL_EFFECT_WEAPON_DAMAGE || sp->m_effect[z] == SPELL_EFFECT_WEAPON_PERCENT_DAMAGE || sp->m_effect[z] == SPELL_EFFECT_DUMMYMELEE )
					sp->is_melee_spell = true;
				if( ( sp->m_effect[z] == SPELL_EFFECT_SCHOOL_DAMAGE && sp->m_defenseType == SPELL_DMG_TYPE_RANGED ) )
				{
					//Log.Notice( "SpellFixes" , "Ranged Spell: %u [%s]" , sp->m_id , sp->Name );
...
//				}
		...
		sp->m_procTypeMask = pr;

		if( strstr( desc, "Must remain seated"))
		{
			sp->m_recoveryTime = 1000;
			sp->m_categoryRecoveryTime = 1000;
		}
		...
		if( strstr( nametext, "Lightning Shield" ) && sp->m_effectTriggerSpell[0] )
		{
			...
			if( startofid )
			{
				...
				sp->m_effectTriggerSpell[0] = atoi( startofid ); //get new lightning shield trigger id
			}
			sp->proc_interval = 3000; //few seconds
		}
		//mage ignite talent should proc only on some chances
		else if( strstr( nametext, "Ignite") && sp->m_id>=11119 && sp->m_id<=12848 && sp->m_effectAura[0] == 4 )
		{
			//check if we can find in the desription
			...
			if(startofid)
			{
				...
				sp->m_effectBasePoints[0]=atoi(startofid); //get new value. This is actually level*8 ;)
			}
			sp->m_effect[0] = 6; //aura
			sp->m_effectAura[0] = 42; //force him to use procspell effect
			sp->m_effectTriggerSpell[0] = 12654; //evil , but this is good for us :D
			sp->m_procTypeMask = PROC_ON_SPELL_CRIT_HIT; //add procflag here since this was not processed with the others !
		}
		...
		else if( strstr( nametext, "Deep Wounds") && sp->m_effectTriggerSpell[0])
		{
			...
			if(startofid)
			{
				...
				sp->m_effectTriggerSpell[0] = atoi(startofid);
			}
		}
		else if( strstr( nametext, "Holy Shock"))
		{
			...
			{
				startofid += strlen(" or $");
				sp->m_effectTriggerSpell[1]=atoi(startofid);
			}
		}
		else if( strstr( nametext, "Touch of Weakness"))
		{
			...
			if(startofid)
			{
				...
				sp->m_effectTriggerSpell[0] = atoi(startofid);
				sp->m_effectTriggerSpell[1]=sp->m_effectTriggerSpell[0]; //later versions of this spell changed to eff[1] the aura
				sp->m_procTypeMask = uint32(PROC_ON_MELEE_ATTACK_VICTIM);
			}
		}
		else if( strstr( nametext, "Firestone Passive"))
		{
			...
			if(startofid)
			{
				...
				sp->m_effectTriggerSpell[0] = atoi(startofid);
				sp->m_effectAura[0] = 42;
				sp->m_procTypeMask = PROC_ON_MELEE_ATTACK;
				sp->m_procChance = 50;
			}
		}
		...
		{
			sp->proc_interval = 3000; //few seconds
			sp->m_procTypeMask |= PROC_TARGET_SELF;
		}
		...
		{
			sp->m_spellClassMask |= 16384; //some of them do have the flags but i's hard to write down those some from 130 spells
			sp->c_is_flags |= SPELL_FLAG_IS_POISON;
		}
		else if( strstr( nametext, "Mind-Numbing Poison"))
		{
			sp->m_spellClassMask |= 32768; //some of them do have the flags but i's hard to write down those some from 130 spells
			sp->c_is_flags |= SPELL_FLAG_IS_POISON;
		}
		else if( strstr( nametext, "Instant Poison"))
		{
			sp->m_spellClassMask |= 8192; //some of them do have the flags but i's hard to write down those some from 130 spells
			sp->c_is_flags |= SPELL_FLAG_IS_POISON;
		}
		else if( strstr( nametext, "Deadly Poison"))
		{
			sp->m_spellClassMask |= 65536; //some of them do have the flags but i's hard to write down those some from 130 spells
			sp->c_is_flags |= SPELL_FLAG_IS_POISON;
		}
		else if( strstr( nametext, "Wound Poison"))
		{
			sp->m_spellClassMask |= 268435456; //some of them do have the flags but i's hard to write down those some from 130 spells
			sp->c_is_flags |= SPELL_FLAG_IS_POISON;
		}
		...
		if( sp->NameHash == SPELL_HASH_SHADOW_BOLT )
			sp->m_spellClassMask |= 1; //some of them do have the flags but i's hard to write down those some from 130 spells
		...
		if( sp->NameHash == SPELL_HASH_CONE_OF_COLD || sp->NameHash == SPELL_HASH_COLD_SNAP || sp->NameHash == SPELL_HASH_ICE_BARRIER || sp->NameHash == SPELL_HASH_ICE_BLOCK )
			sp->m_effectItemType[0] = 0x00200000;

/*		else if( strstr( nametext, "Anesthetic Poison"))
			sp->m_spellClassMask |= 0; //not yet known ? 
		else if( strstr( nametext, "Blinding Powder"))
			sp->m_spellClassMask |= 0; //not yet known ?
		else 
		if( sp->NameHash == SPELL_HASH_ILLUMINATION )
			sp->m_effectTriggerSpell[0] = 20272;*/  // broken trigger spell, do not use
		//sp->dummy=result;
/*		//if there is a proc spell and has 0 as charges then it's probably going to triger infinite times. Better not save these
		if(sp->m_procCharges==0)
			sp->m_procCharges=-1;*/
		if( sp->NameHash == SPELL_HASH_ILLUMINATION )
			sp->m_procTypeMask |= PROC_TARGET_SELF;

		//Set Silencing spells mech.
		if( sp->m_effectAura[0] == 27 || 
			sp->m_effectAura[1] == 27 ||
			sp->m_effectAura[2] == 27 )
			sp->m_mechanic = MECHANIC_SILENCED;

		//Set Stunning spells mech.
		if( sp->m_effectAura[0] == 12 || 
			sp->m_effectAura[1] == 12 ||
			sp->m_effectAura[2] == 12 )
			sp->m_mechanic = MECHANIC_STUNNED;

		//Set Fearing spells mech
		if( sp->m_effectAura[0] == 7 || 
			sp->m_effectAura[1] == 7 ||
			sp->m_effectAura[2] == 7 )
			sp->m_mechanic = MECHANIC_FLEEING;

		if( sp->proc_interval != 0 )
			sp->m_procTypeMask |= PROC_REMOVEONUSE;

		// Seal of Command - Proc Chance
		if( sp->NameHash == SPELL_HASH_SEAL_OF_COMMAND )
		{
			sp->m_procChance = 25;
			sp->m_schoolMask = SCHOOL_HOLY; //the procspells of the original seal of command have fizical school instead of holy
			sp->m_defenseType = SPELL_DMG_TYPE_MAGIC; //heh, crazy spell uses melee/ranged/magic dmg type for 1 spell. Now which one is correct ?
		}
		...
		if(
			((sp->m_attributes & ATTRIBUTES_TRIGGER_COOLDOWN) && (sp->m_attributesEx & ATTRIBUTESEX_NOT_BREAK_STEALTH)) //rogue cold blood
			|| ((sp->m_attributes & ATTRIBUTES_TRIGGER_COOLDOWN) && (!sp->m_attributesEx || sp->m_attributesEx & ATTRIBUTESEX_REMAIN_OOC))
			)
		{
...
//if(sp->m_id==11267 || sp->m_id==11289 || sp->m_id==6409)
//	printf("!!!!!!! name %s , id %u , hash %u \n",nametext,sp->m_id, namehash);
	}
	...
	for(uint32 x=0; x < cnt; x++)
	{
		...
		SpellCastTime *sd = dbcSpellCastTime.LookupEntry(sp->m_castingTimeIndex);
		...
		for( uint8 i = 0 ; i < 3 ; i++ )
		{
			if (sp->m_effectAura[i] == SPELL_AURA_PERIODIC_DAMAGE ||
				sp->m_effectAura[i] == SPELL_AURA_PERIODIC_HEAL ||
				sp->m_effectAura[i] == SPELL_AURA_PERIODIC_LEECH )
			{
		...
		for( uint8 i = 0 ; i < 3 ; i++ )
		{
			if ( sp->m_effectAura[i] == SPELL_AURA_PERIODIC_TRIGGER_SPELL && sp->m_effectTriggerSpell[i] )
			{
				spz = dbcSpell.LookupEntry( sp->m_effectTriggerSpell[i] );
				if( spz &&
					spz->m_effect[i] == SPELL_EFFECT_SCHOOL_DAMAGE ||
					spz->m_effect[i] == SPELL_EFFECT_HEAL
					) 
					spcheck = true;
			}
			if (sp->m_effect[i] == SPELL_EFFECT_SCHOOL_DAMAGE ||
				sp->m_effect[i] == SPELL_EFFECT_HEAL ||
				spcheck
				)
			{
		...
		//Channeled spells
		if( sp->m_channelInterruptFlags != 0 )
		{
			float Duration = float( GetDuration( dbcSpellDuration.LookupEntry( sp->m_durationIndex ) ));
		...
		// Attack Power Coefficient -> Death Knights
		sp->fixed_apcoefficient = 0.0f;
		///	SPELLS CAN CRIT ///
		...
		// Insert hunter spell fixes here
			...
			*/
			...
			if( sp->m_equippedItemClass == 2 && sp->m_equippedItemSubclass & 262156 ) // 4 + 8 + 262144 ( becomes item classes 2, 3 and 18 which correspond to bow, gun and crossbow respectively)
			{
				sp->is_ranged_spell = true;
			}
		...
		// Insert Deah Knight fixes here.

			// Set up Attack Power coefficients.
			// hmm, without namehashes this will be slow xD
			/*if( sp->m_id >= 42650 ) // try to avoid conflicts with other spells + speed up loading time
			{
			if( sp->m_name_lang[0] == "Strangulate" )
				sp->fixed_apcoefficient = 0.2f;
			else if( sp->m_name_lang[0] == "Blood Boil" )
				sp->fixed_apcoefficient = 0.1f;
			else if( sp->m_name_lang[0] == "Death Coil" ) 
				sp->fixed_apcoefficient = 0.25f;
			else if( sp->m_name_lang[0] == "Death and Decay" )
				sp->fixed_apcoefficient = 0.039f;
			else if( sp->m_name_lang[0] == "Icy Touch" )
				sp->fixed_apcoefficient = 0.2f;
			else if( sp->m_name_lang[0] == "Mind Freeze" )
				sp->fixed_apcoefficient = 0.1f;*/
			if( sp->m_id == 49909 )
				sp->fixed_apcoefficient = 0.1f;

			if( sp->fixed_apcoefficient )
			Log.Notice( "COEF" , "coef %u (%s) = %f" , sp->m_id , sp->m_name_lang[0] , sp->fixed_apcoefficient );
	...
	for(uint32 x=0; x < cnt; x++)
	{
		...
		for( uint8 i = 0 ; i < 3 ; i++ )
		{
			if ( sp->m_effectAura[i] == SPELL_AURA_PERIODIC_TRIGGER_SPELL )
			{
				spz = dbcSpell.LookupEntry( sp->m_effectTriggerSpell[i] );
				if( spz != NULL ) 
				{
					...
					else
					{
						...
						{
							float Duration = float( GetDuration( dbcSpellDuration.LookupEntry( sp->m_durationIndex ) ));
							float amp = float(sp->m_effectAmplitude[i]);
	...
	if( Enchantment != NULL )
	{
		...
		if( sp != NULL )
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK; //we do not need proc on spell ;)
			sp->m_effectTriggerSpell[0] = 8232; //for the logs and rest
			sp->m_procChance = 20;
			sp->proc_interval = 3000;//http://www.wowwiki.com/Windfury_Weapon
			sp->m_cumulativeAura = 1;
		}
	}
	...
	if( Enchantment != NULL )
	{
		...
		if( sp != NULL )
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK; //we do not need proc on spell ;)
			sp->m_effectTriggerSpell[0] = 8235; //for the logs and rest
			sp->m_procChance = 20;
			sp->proc_interval = 3000; //http://www.wowwiki.com/Windfury_Weapon
			sp->m_cumulativeAura = 1;
		}
	...
	if( Enchantment != NULL )
	{
		...
		if( sp != NULL )
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK; //we do not need proc on spell ;)
			sp->m_effectTriggerSpell[0] = 10486; //for the logs and rest
			sp->m_procChance = 20;
			sp->proc_interval = 3000;//http://www.wowwiki.com/Windfury_Weapon
			sp->m_cumulativeAura = 1;
		}
	...
	if( Enchantment != NULL )
	{
		...
		if( sp != NULL )
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK; //we do not need proc on spell ;)
			sp->m_effectTriggerSpell[0] = 16362; //for the logs and rest
			sp->m_procChance = 20;
			sp->proc_interval = 3000;//http://www.wowwiki.com/Windfury_Weapon
			sp->m_cumulativeAura = 1;
		}
	...
	if( Enchantment != NULL )
	{
		...
		if( sp != NULL )
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK; //we do not need proc on spell ;)
			sp->m_effectTriggerSpell[0] = 25505; //for the logs and rest
			sp->m_procChance = 20;
			sp->proc_interval = 3000;//http://www.wowwiki.com/Windfury_Weapon
			sp->m_cumulativeAura = 1;
		}
	...
	if( sp != NULL )
	{
		sp->m_effectAura[0] = SPELL_AURA_ADD_PCT_MODIFIER;
		sp->m_effectMiscValue[0] = SMT_COST;
		sp->m_effectItemType[0] = 0xFFFFFFFF; //all possible spells we can affect
	}
	sp = dbcSpell.LookupEntryForced( 16246 );
	if( sp != NULL )
	{
	...
	if( sp != NULL )
	{
		sp->m_effect[0] = SPELL_EFFECT_TRIGGER_SPELL;
		sp->m_effectTriggerSpell[0] = 26635;
	}
	...
	for(i = 0; thrown_spells[i] != 0; ++i)
	{
		...
		if( sp != NULL && sp->m_recoveryTime==0 && sp->m_startRecoveryTime == 0 )
			sp->m_recoveryTime = 1600;
	}
	...
	if( sp != NULL )
		sp->m_defenseType = SPELL_DMG_TYPE_RANGED;
	...
	if( sp != NULL )
	{
		sp->m_implicitTargetB[0]=0;
	}

	sp = dbcSpell.LookupEntryForced(23179);
	if( sp != NULL )
		sp->m_effectMiscValue[0] = 1434;
	...
	// Insert warrior spell fixes here
		...
		if( sp != NULL )
		{
			sp->m_effect[0] = 6; //aura
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 22858; //evil , but this is good for us :D
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK_VICTIM; //add procflag here since this was not processed with the others !
		}
		...
		if( sp != NULL )
		{
			sp->m_effect[1] = 64; //cast on us, it is good
			sp->m_effectTriggerSpell[1] = 23885; //evil , but this is good for us :D
		}
		sp = dbcSpell.LookupEntryForced( 23892 );
		if( sp != NULL )
		{
			sp->m_effect[1] = 64;
			sp->m_effectTriggerSpell[1] = 23886; //evil , but this is good for us :D
		}
		sp = dbcSpell.LookupEntryForced( 23893 );
		if( sp != NULL )
		{
			sp->m_effect[1] = 64; //
			sp->m_effectTriggerSpell[1] = 23887; //evil , but this is good for us :D
		}
		sp = dbcSpell.LookupEntryForced( 23894 );
		if( sp != NULL )
		{
			sp->m_effect[1] = 64; //
			sp->m_effectTriggerSpell[1] = 23888; //evil , but this is good for us :D
		}
		sp = dbcSpell.LookupEntryForced( 25251 );
		if( sp != NULL )
		{
			sp->m_effect[1] = 64; //aura
			sp->m_effectTriggerSpell[1] = 25252; //evil , but this is good for us :D
		}
		sp = dbcSpell.LookupEntryForced( 30335 );
		if( sp != NULL )
		{
			sp->m_effect[1] = 64; //aura
			sp->m_effectTriggerSpell[1] = 30339; //evil , but this is good for us :D
		}
		//rend
		sp = dbcSpell.LookupEntryForced( 772 );
		if( sp != NULL )
			sp->m_mechanic = MECHANIC_BLEEDING;
		sp = dbcSpell.LookupEntryForced( 6546 );
		if( sp != NULL )
			sp->m_mechanic = MECHANIC_BLEEDING;
		sp = dbcSpell.LookupEntryForced( 6547 );
		...
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK | PROC_TARGET_SELF;
			sp->m_effectTriggerSpell[0] = sp->m_effectTriggerSpell[1];
		}
		...
		if (sp != NULL )
		{
			sp->m_effectItemType[0] = 16 | 8192;
			sp->m_effectMiscValue[0] = 8;
			sp->m_effectItemType[1] = 16 | 8192;
			sp->m_effectMiscValue[1] = 8;
		}
		...
		{
			sp->m_effect[2] = 6;
			sp->m_effectAura[2] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[2] = 37521; //not sure if this is the one. In my time this adds 30 rage
			sp->m_procTypeMask = PROC_ON_ANY_DAMAGE_VICTIM | PROC_TARGET_SELF;
		}

		//warrior - improved berserker rage
		sp = dbcSpell.LookupEntryForced( 20500 );
		if( sp != NULL )
			sp->m_procTypeMask = PROC_ON_CAST_SPELL | PROC_TARGET_SELF;
		...
		if( sp != NULL )
		{
			sp->m_effect[2] = 6;
			sp->m_effectAura[2] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[2] = 9174; //not sure if this is the one. In my time this adds 30 rage
			sp->m_procTypeMask = PROC_ON_ANY_DAMAGE_VICTIM | PROC_TARGET_SELF;
		}
		...
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 65536 | 131072;
			sp->m_effectMiscValue[0] = 128;
			sp->m_effectItemType[1] = 65536 | 131072;
			sp->m_effectMiscValue[1] = 128;
		}
		sp = dbcSpell.LookupEntryForced( 12835 );
		if( sp != NULL )
		{
		...
		if ( sp != NULL )
		{
			sp->m_effectMiscValue[1] = 1024;
			sp->m_effectItemType[2] =33554432;
		}
		sp = dbcSpell.LookupEntryForced( 12676 );
		if ( sp != NULL )
		{
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 8 | 1 | 4 | 32 | 2 | 4194304 | 536870912 | 2097152 | 128 | 134217728 | 1073741824UL | 2048 | 64 | 1024 | 33554432;
			sp->m_effectMiscValue[0] = 8 | 256 | 64;
		}
		...
		sp = dbcSpell.LookupEntryForced( 16493 );
		if( sp != NULL )
			sp->m_effectItemType[0] = 8 | 1 | 4 | 32 | 2 | 4194304 | 536870912 | 2097152 | 128 | 134217728 | 1073741824 | 2048 | 64 | 1024;
		sp = dbcSpell.LookupEntryForced( 16494 );
		if( sp != NULL )
			sp->m_effectItemType[0] = 8 | 1 | 4 | 32 | 2 | 4194304 | 536870912 | 2097152 | 128 | 134217728 | 1073741824 | 2048 | 64 | 1024;
	...
	// Insert paladin spell fixes here
		...
		if( sp != NULL )
		{
			sp->m_effectAura[0] = SPELL_AURA_DUMMY;
			sp->m_effectAura[1] = SPELL_AURA_DUMMY;
		}
		...
		sp = dbcSpell.LookupEntryForced( 20237 );
		if( sp != NULL )
			sp->m_effectItemType[0] = 0x40000000 | 0x80000000;
		if( sp != NULL )
			sp->m_effectItemType[0] = 0x40000000 | 0x80000000;
		sp = dbcSpell.LookupEntryForced( 20239 );
		if( sp != NULL )
		...
		{
			sp->m_effectItemType[0]=128;
			sp->m_effectItemType[1]=268435472;
		}
		sp = dbcSpell.LookupEntryForced( 20174 );
		if (sp != NULL)
		{
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = 131072 | 67108864 | 8 | 64;
		...
		sp = dbcSpell.LookupEntryForced( 20359 );
		if( sp != NULL )
			sp->m_effectItemType[0] = group_relation_paladin_sanctified_light;
		sp = dbcSpell.LookupEntryForced( 20360 );
		if( sp != NULL )
			sp->m_effectItemType[0] = group_relation_paladin_sanctified_light;
		sp = dbcSpell.LookupEntryForced( 20361 );
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = 0x80000000;
		...
		if( sp != NULL )
			sp->m_effectItemType[1] = 0xFFFFFFFF;
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = 1048576 | 524288 | 1024 | 536870912 | 524288;
		...
		{
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK;
			sp->m_effectTriggerSpell[0] = 31803;
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
		}
		...
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_ANY_DAMAGE_VICTIM;
			sp->m_effectTriggerSpell[0] = 20268;
		}
		sp = dbcSpell.LookupEntryForced( 20354 );
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_ANY_DAMAGE_VICTIM;
			sp->m_effectTriggerSpell[0] = 20352;
		}
		sp = dbcSpell.LookupEntryForced( 20355 );
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_ANY_DAMAGE_VICTIM;
			sp->m_effectTriggerSpell[0] = 20353;
		}
		sp = dbcSpell.LookupEntryForced( 27164 );
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_ANY_DAMAGE_VICTIM;
			sp->m_effectTriggerSpell[0] = 27165;
		}

		sp = dbcSpell.LookupEntryForced( 20268 );
		if( sp != NULL )
			sp->m_implicitTargetA[0] = EFF_TARGET_SINGLE_ENEMY;
		sp = dbcSpell.LookupEntryForced( 20352 );
		if( sp != NULL )
			sp->m_implicitTargetA[0] = EFF_TARGET_SINGLE_ENEMY;
		sp = dbcSpell.LookupEntryForced( 20353 );
		...
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK_VICTIM;
			sp->m_effectTriggerSpell[0] = 20267;
		}
		sp = dbcSpell.LookupEntryForced( 20344 );
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK_VICTIM;
			sp->m_effectTriggerSpell[0] = 20341;
		}
		sp = dbcSpell.LookupEntryForced( 20345 );
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK_VICTIM;
			sp->m_effectTriggerSpell[0] = 20342;
		}
		sp = dbcSpell.LookupEntryForced( 20346 );
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK_VICTIM;
			sp->m_effectTriggerSpell[0] = 20343;
		}
		sp = dbcSpell.LookupEntryForced( 27162 );
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK_VICTIM;
			sp->m_effectTriggerSpell[0] = 27163;
		}
		sp = dbcSpell.LookupEntryForced( 20267 );
		if( sp != NULL )
			sp->m_implicitTargetA[0] = EFF_TARGET_SINGLE_ENEMY;
		...
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_SPELL_CRIT_HIT_VICTIM;
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 25997;
		}
		...
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 31930;
		}
		...
		{
			sp->m_procTypeMask = PROC_ON_ANY_DAMAGE_VICTIM;
			sp->m_effectTriggerSpell[0] = 31828;
		}
		...
		if( sp != NULL )
			procchance = sp->m_procChance;
		sp = dbcSpell.LookupEntryForced( 20166 );
		if( sp != NULL )
			sp->m_procChance = procchance;
		...
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK;
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 31893;
		}
		...
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_SPELL_HIT_VICTIM | PROC_TARGET_SELF ;
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 31786;
		}
		...
		{
			sp->m_effectItemType[0] = 67108864;
			sp->m_effectMiscValue[0] = SMT_SPELL_VALUE;
		}
	...
	// Insert hunter spell fixes here
		...
		if( sp != NULL )
			sp->m_procTypeMask = PROC_ON_RANGED_ATTACK | PROC_TARGET_SELF;
		...
		if( sp != NULL )
		{
			...
			sp->m_effect[0] = SPELL_EFFECT_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 19579;
		}
		...
		if( sp != NULL )
		{
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_PET_OWNER | SPELL_FLAG_IS_EXPIREING_WITH_PET;
			sp->m_effect[0] = SPELL_EFFECT_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 24529;
		}
		sp = dbcSpell.LookupEntryForced( 19579 );
		if( sp != NULL )
		{
			sp->c_is_flags |= SPELL_FLAG_IS_EXPIREING_WITH_PET;
			sp->m_effect[1] = SPELL_EFFECT_APPLY_AURA; //we should do the same for player too as we did for pet
			sp->m_effectAura[1] = sp->m_effectAura[0];
			sp->m_implicitTargetA[1] = EFF_TARGET_PET;
			sp->m_effectBasePoints[1] = sp->m_effectBasePoints[0];
			sp->m_effectAmplitude[1] = sp->m_effectAmplitude[0];
			sp->m_effectDieSides[1] = sp->m_effectDieSides[0];
		}
		...
		if(sp != NULL)
		{
			sp->m_effectAura[1] = SPELL_AURA_MOD_SILENCE ;
		}
		...
		if( sp != NULL )
		{
			...
			sp->m_effectAura[1] = SPELL_AURA_MOD_HIT_CHANCE;
			sp->m_implicitTargetA[1] = EFF_TARGET_PET;
		}
		...
		{
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_ON_PET ;
			sp->m_effectAura[1] = SPELL_AURA_MOD_HASTE;
			sp->m_implicitTargetA[1] = EFF_TARGET_PET;
		}
		...
		if( sp != NULL )
		{
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_ON_PET;
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_implicitTargetA[0] = EFF_TARGET_PET;
			sp->m_effectTriggerSpell[0] = 34456;
			sp->m_procTypeMask = PROC_ON_SPELL_CRIT_HIT | PROC_TARGET_SELF; //maybe target master ?
			sp->m_effect[1] = 0; //remove this
		}
		...
		if( sp != NULL )
		{
			...
			sp->m_implicitTargetA[0] = EFF_TARGET_PET;
			sp->m_effectTriggerSpell[0] = 34456;
			sp->m_procTypeMask = PROC_ON_SPELL_CRIT_HIT | PROC_TARGET_SELF; 
			sp->m_effect[1] = 0; //remove this
		}
		...
		if( sp != NULL )
		{
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_PET_OWNER | SPELL_FLAG_IS_EXPIREING_WITH_PET;
			sp->m_effect[0] = SPELL_EFFECT_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 35060;
			sp->m_effectMiscValue[1] = 2048;
		}
		...
		if( sp != NULL )
		{
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_PET_OWNER | SPELL_FLAG_IS_EXPIREING_WITH_PET;
			sp->m_effect[0] = SPELL_EFFECT_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 35061;
			sp->m_effectMiscValue[1] = 2048;
		}
		...
		if( sp != NULL )
		{
			...
			sp->m_effectAura[0] = SPELL_AURA_MOD_RESISTANCE; //we do not support armor rating for pets yet !
			sp->m_effectBasePoints[0] *= 10; //just give it a little juice :P
			sp->m_implicitTargetA[0] = EFF_TARGET_PET;
		}
		sp = dbcSpell.LookupEntryForced( 19610 );
		if( sp != NULL )
		...
		{
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_ON_PET;
			sp->m_effectAura[0] = SPELL_AURA_MOD_CRIT_PERCENT;
			sp->m_implicitTargetA[0] = EFF_TARGET_PET;
		}
		sp = dbcSpell.LookupEntryForced( 19599 );
		if( sp != NULL )
		...
		{
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_ON_PET;
			sp->m_effectAura[0] = SPELL_AURA_MOD_INCREASE_SPEED; 
			sp->m_implicitTargetA[0] = EFF_TARGET_PET;
		}
		...
		{
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_PET_OWNER ;
			sp->m_effectAura[0] = SPELL_AURA_MOD_INCREASE_HEALTH_PERCENT;
			sp->m_implicitTargetA[0] = EFF_TARGET_PET;
		}
		sp = dbcSpell.LookupEntryForced( 19584 );
		if( sp != NULL )
		...
		if( sp != NULL )
		{
			...
			sp->m_procChance = sp->m_effectBasePoints[0]+1;
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 34720;
		}
		...
		if( sp != NULL )
			sp->m_procTypeMask = PROC_ON_RANGED_CRIT_ATTACK;
		...
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 19615;
			sp->m_implicitTargetA[0] = EFF_TARGET_PET;
			sp->m_procChance = sp->m_effectBasePoints[0];
			sp->m_procTypeMask = PROC_ON_CRIT_ATTACK;
		...
		if( sp != NULL )
		{
			sp->m_effectAura[0] = SPELL_AURA_MOD_DAMAGE_PERCENT_DONE;
			sp->m_implicitTargetA[0] = EFF_TARGET_PET;
			sp->m_effectMiscValue[0] = 1; //tweekign melee dmg
		...
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_GAIN_EXPIERIENCE | PROC_TARGET_SELF;
			sp->m_effectItemType[1] = 32;
		}
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = 131072 | 2048 | 1;
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 16384 | 65536;
			sp->m_effectItemType[1] = 65536;
			sp->m_effectItemType[2] = 16384 | 65536 | 32768;
		}
		sp = dbcSpell.LookupEntryForced( 19465 );
		if( sp != NULL )
		{
		...
		sp = dbcSpell.LookupEntryForced( 19485 );
		if( sp != NULL )
			sp->m_effectItemType[0] = 4 ; //simple shot
		sp = dbcSpell.LookupEntryForced( 19487 );
		if( sp != NULL )
			sp->m_effectItemType[0] = 4 ; //simple shot
		sp = dbcSpell.LookupEntryForced( 19488 );
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 128 | 2 | 64; 
			sp->m_effectItemType[1] = 128;
		}
		...
		*/
		...
		if( sp != NULL )
			sp->m_effect[0] = SPELL_EFFECT_APPLY_AREA_AURA;
		sp = dbcSpell.LookupEntryForced( 13159 );
		if( sp != NULL )
			sp->m_effect[1] = SPELL_EFFECT_APPLY_AREA_AURA;

		/* aspect of the cheetah - add proc flags */
		sp = dbcSpell.LookupEntryForced( 5118 );
		if( sp != NULL )
			sp->m_procTypeMask = 139944;

		sp = dbcSpell.LookupEntryForced(34471);
		if(sp!=NULL)
		{
					sp->m_effectAura[0] = 72 ;
					sp->m_effectAura[1] = 79 ;
					sp->m_effectAura[2] = 77 ;
		}
	...
	// Insert rogue spell fixes here
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = group_relation_rogue_elusiveness;
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = group_relation_rogue_poisons;
			sp->m_effectItemType[1] = 0x00800000; //maybe this is mixed up with 0 grouprelation ?
			sp->m_effectItemType[2] = group_relation_rogue_poisons;
		}
		...
		sp = dbcSpell.LookupEntryForced( 14168 ); 
		if( sp != NULL )
			sp->m_effectItemType[0] = 0x00080000;
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = group_relation_rogue_find_weakness;
		...
		if( sp != NULL )
			sp->m_attributesEx |= ATTRIBUTESEX_NOT_BREAK_STEALTH;
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 16777216 | 128; // blind + sap
			sp->m_effectItemType[1] = 16777216 | 128; // blind + sap
		}
		sp = dbcSpell.LookupEntryForced( 14094 ); 
		if( sp != NULL )
		{
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = 1024 | 256; // Cheap Shot + Garrote
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[3] = group_relation_rogue_shadow_step;
			sp->m_effectMiscValue[3] = 256 | 128 ;
			sp->m_effectMiscValue[3] = SMT_SPELL_VALUE;
			sp->m_effectTriggerSpell[1] = 36554;
			sp->m_effectTriggerSpell[2] = 44373;
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;	
		}
		...
		sp = dbcSpell.LookupEntryForced( 14128 ); 
		if( sp != NULL )
			sp->m_effectItemType[0] = group_relation_rogue_lethality;
		sp = dbcSpell.LookupEntryForced( 14132 ); 
		if( sp != NULL )
			sp->m_effectItemType[0] = group_relation_rogue_lethality;
		sp = dbcSpell.LookupEntryForced( 14135 ); 
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = 64 | 32;	//Sprint + Evasion
		...
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 14189;
			sp->m_procTypeMask = PROC_ON_CRIT_ATTACK;
			sp->m_procChance = 20;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;//proc spell
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_effectBasePoints[1] = 20; //client showes 20% chance but whe do not have it ? :O
		}
	#else
		//Relentless Strikes
		sp = dbcSpell.LookupEntryForced( 14179 );
		if( sp != NULL )
			sp->m_effectItemType[0]= 262144 | 2097152 | 8388608 | 8519680 | 524288 | 1048576 | 8388608;
	#endif
	#ifndef NEW_PROCFLAGS
		//rogue - intiative
		...
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_procTypeMask = uint32(PROC_ON_CAST_SPELL|PROC_TARGET_SELF);
		}
		...
		sp = dbcSpell.LookupEntryForced( 13976 );
		if( sp != NULL )
			sp->m_effectItemType[0] = 8389120 | 256 | 1024;
		sp = dbcSpell.LookupEntryForced( 13979 );
		if( sp != NULL )
			sp->m_effectItemType[0] = 8389120 | 256 | 1024;
		sp = dbcSpell.LookupEntryForced( 13980 );
	...
	// Insert priest spell fixes here
		...
		{
			sp->m_effect[1] = 64;
			sp->m_effectTriggerSpell[1] = 23455;
		}
		sp = dbcSpell.LookupEntryForced( 15430 );
		if( sp != NULL )
		{
			sp->m_effect[1] = 64;
			sp->m_effectTriggerSpell[1] = 23458;
		}
		sp = dbcSpell.LookupEntryForced( 15431 );
		if( sp != NULL )
		{
			sp->m_effect[1] = 64;
			sp->m_effectTriggerSpell[1] = 23459;
		}
		sp = dbcSpell.LookupEntryForced( 27799 );
		if( sp != NULL )
		{
			sp->m_effect[1] = 64;
			sp->m_effectTriggerSpell[1] = 27803;
		}
		sp = dbcSpell.LookupEntryForced( 27800 );
		if( sp != NULL )
		{
			sp->m_effect[1] = 64;
			sp->m_effectTriggerSpell[1] = 27804;
		}
		sp = dbcSpell.LookupEntryForced( 27801 );
		if( sp != NULL )
		{
			sp->m_effect[1] = 64;
			sp->m_effectTriggerSpell[1] = 27805;
		}
		sp = dbcSpell.LookupEntryForced( 25331 );
		if( sp != NULL )
		{
			sp->m_effect[1] = 64;
			sp->m_effectTriggerSpell[1] = 25329;
		}
		 ...
		 if (sp != NULL)
		 {
			  //sp->m_effectItemType[0] = 2048 | 4096;
			  sp->m_effectMiscValue[0] = 4;
		 }
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = 8192 | 131072 | 8388608; // Mind Blast + Mind Control + Mind Flay
		...
		if(sp != NULL)
		{
			sp->m_effectTriggerSpell[0] = 27813;
			sp->m_procTypeMask = PROC_ON_CRIT_HIT_VICTIM;
		}
		sp = dbcSpell.LookupEntryForced(27815);
		if(sp != NULL)
		{
			sp->m_effectTriggerSpell[0] = 27817;
			sp->m_procTypeMask = PROC_ON_CRIT_HIT_VICTIM;
		}
		sp = dbcSpell.LookupEntryForced(27816);
		if(sp != NULL)
		{
			sp->m_effectTriggerSpell[0] = 27818;
			sp->m_procTypeMask = PROC_ON_CRIT_HIT_VICTIM;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 4194304 | 128 | 32768 | 8192 | 16 | 1048576 | 8388608 | 2097152 | 67108864;
			sp->m_effectItemType[1] = 4194304 | 128 | 32768 | 8192 | 16 | 1048576 | 8388608 | 2097152 | 67108864;
			sp->m_effectItemType[2] = 0 ;	//1-2 mod the same ?
			sp->m_effectMiscValue[0] = 2 | 1024 ;
			sp->m_effectMiscValue[1] = 2 | 1024 ;
		}
		sp = dbcSpell.LookupEntryForced( 18547 ); 
		if( sp != NULL )
		{
		...
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_SPELL_HIT_VICTIM | PROC_ON_RANGED_ATTACK_VICTIM | PROC_ON_MELEE_ATTACK_VICTIM;
			sp->proc_interval = 3000; //every 3 seconds
			sp->m_effectTriggerSpell[0] = 28377;
		}
		sp = dbcSpell.LookupEntryForced( 19308 );
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_SPELL_HIT_VICTIM | PROC_ON_RANGED_ATTACK_VICTIM | PROC_ON_MELEE_ATTACK_VICTIM;
			sp->proc_interval = 3000; //every 3 seconds
			sp->m_effectTriggerSpell[0] = 28378;
		}
		sp = dbcSpell.LookupEntryForced( 19309 );
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_SPELL_HIT_VICTIM | PROC_ON_RANGED_ATTACK_VICTIM | PROC_ON_MELEE_ATTACK_VICTIM;
			sp->proc_interval = 3000; //every 3 seconds
			sp->m_effectTriggerSpell[0] = 28379;
		}
		sp = dbcSpell.LookupEntryForced( 19310 );
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_SPELL_HIT_VICTIM | PROC_ON_RANGED_ATTACK_VICTIM | PROC_ON_MELEE_ATTACK_VICTIM;
			sp->proc_interval = 3000; //every 3 seconds
			sp->m_effectTriggerSpell[0] = 28380;
		}
		sp = dbcSpell.LookupEntryForced( 19311 );
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_SPELL_HIT_VICTIM | PROC_ON_RANGED_ATTACK_VICTIM | PROC_ON_MELEE_ATTACK_VICTIM;
			sp->proc_interval = 3000; //every 3 seconds
			sp->m_effectTriggerSpell[0] = 28381;
		}
		sp = dbcSpell.LookupEntryForced( 19312 );
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_SPELL_HIT_VICTIM | PROC_ON_RANGED_ATTACK_VICTIM | PROC_ON_MELEE_ATTACK_VICTIM;
			sp->proc_interval = 3000; //every 3 seconds
			sp->m_effectTriggerSpell[0] = 28382;
		}
		sp = dbcSpell.LookupEntryForced( 25477 );
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_SPELL_HIT_VICTIM | PROC_ON_RANGED_ATTACK_VICTIM | PROC_ON_MELEE_ATTACK_VICTIM;
			sp->proc_interval = 3000; //every 3 seconds
			sp->m_effectTriggerSpell[0] = 28385;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 2147483648UL | 65536 | 67108864UL | 4 | 1 | 64 | 32 | 4194304UL | 32768 | 8388608UL | 8 | 16384 | 2 | 256 | 16777216UL | 2097152UL | 33554432UL;
			sp->m_effectMiscValue[0] = 1 | 64 | 2;
		}
		sp = dbcSpell.LookupEntryForced( 14780 ); 
		if( sp != NULL )
		{
		...
		{
			sp->m_effectItemType[0] = 2147483648UL;
			sp->m_effectItemType[1] = 128 | 8192 | 2147483648UL;
		}
		...
		sp = dbcSpell.LookupEntryForced( 17322 ); 
		if( sp != NULL )
			sp->m_effectItemType[0] = 32768 | 65536 | 4 | 8192 | 16 | 8388608 | 2147483648UL;
		sp = dbcSpell.LookupEntryForced( 17323 ); 
		if( sp != NULL )
			sp->m_effectItemType[0] = 32768 | 65536 | 4 | 8192 | 16 | 8388608 | 2147483648UL;
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 65536 | 67108864 | 131072 | 2147483648UL | 32768 | 8192 | 16 | 4 | 8388608 | 16384 | 256 | 33554432;
			sp->m_effectMiscValue[0] = 64 | 2 | 1024;
		}
		sp = dbcSpell.LookupEntryForced( 15327 ); 
		if( sp != NULL )
		{
		...
		if( sp != NULL )
		{
			uint32 group = sp->m_effectItemType[0];
			sp = dbcSpell.LookupEntryForced( 33221 );
			if( sp != NULL )
				sp->m_effectItemType[0] = group;
		...
		if( sp != NULL )
			sp->m_procTypeMask = uint32(PROC_ON_SPELL_CRIT_HIT_VICTIM | PROC_TARGET_SELF);
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 128;
			sp->m_effectItemType[1] = 128;
			sp->m_effectItemType[2] = 128;
			sp->m_auraInterruptFlags = AURA_INTERRUPT_ON_CAST_SPELL;
		}
		// priest - Reflective Shield
		sp = dbcSpell.LookupEntryForced( 33201 );
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_ABSORB;
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 33619; //!! WRONG spell, we will make direct dmg here
		}
	...
	// Insert shaman spell fixes here
		...
		if( parentsp != NULL && triggersp != NULL )
			triggersp->m_effectBasePoints[0] = parentsp->m_effectBasePoints[0];

		/**********************************************************
		 *	Elemental Focus
		 **********************************************************/
		sp = dbcSpell.LookupEntryForced( 16164 );
		if( sp != NULL && sp->m_id == 16164 )
			sp->m_procTypeMask = PROC_ON_SPELL_CRIT_HIT;

		/**********************************************************
		 *	Stormstrike
		 **********************************************************/
		sp = dbcSpell.LookupEntryForced( 17364 );
		if( sp != NULL && sp->m_id == 17364 )
			sp->m_effect[0] = 0;
		...
		if( sp != NULL )
		{
			sp->m_implicitTargetA[0] = EFF_TARGET_ALL_PARTY;
			sp->m_implicitTargetA[1] = EFF_TARGET_ALL_PARTY;
			sp->m_implicitTargetA[2] = 0;
			sp->m_implicitTargetB[0] = 0;
			sp->m_implicitTargetB[1] = 0;
			sp->m_implicitTargetB[2] = 0;
		}
		...
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 39805;//proc something (we will owerride this)
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 0xFFFFFFFF;//nature+fire+frost is all that shaman can do
			sp->m_effectMiscValue[0] = 0xFFFFFFFF;//nature+fire+frost is all that shaman can do
			sp->m_effectItemType[1] = 0xFFFFFFFF;//nature+fire+frost is all that shaman can do
			sp->m_effectMiscValue[1] = 0xFFFFFFFF;//nature+fire+frost is all that shaman can do
		}
		/**********************************************************
		 *	Eye of the Storm
		 **********************************************************/
		...
		if( sp != NULL )
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_procTypeMask = PROC_ON_CRIT_ATTACK;
			sp->m_effectTriggerSpell[0] = 43339;
			sp->m_procChance = 100;
			sp->m_cumulativeAura = 1;
		}
		...
		{
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_effectAura[1] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectMiscValue[0] = SMT_COST;
			sp->m_effectItemType[0] = 1048576UL | 268435456UL | 2147483648UL;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] =  0xFFFFFFFF; // shaman spells. Guess that wraps them all 
			sp->m_effectMiscValue[0] =  0xFFFFFFFF; // shaman spells. Guess that wraps them all 
		}
		...
		if( sp != NULL )
			sp->m_effectItemType[0] =  64 | 128 | 256;
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = group_relation_shaman_enhancing_totems;
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 0xFFFFFFFF ; //damn, what other spells do there remain after that list ? Maybe later :P
			//sp->m_effectItemType[0] = 1073741824 | 32 | 1048576 | 1 | ... ; //Searing/Magma/Fire Nova Totem effects and Fire,Frost,Nature spells
			sp->m_effectMiscValue[0] = 0xFFFFFFFF ; //damn, what other spells do there remain after that list ? Maybe later :P
		}
		...
		sp = dbcSpell.LookupEntryForced( 16259 ); 
		if( sp != NULL )
			sp->m_effectItemType[0] = group_relation_shaman_restorative_totems;
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = group_relation_shaman_mental_quickness;
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = group_relation_shaman_totems;
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = group_relation_shaman_lightning;
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = group_relation_shaman_shock | group_relation_shaman_lightning;
		...
		if( sp != NULL )
		{
			sp->m_implicitTargetA[0] = EFF_TARGET_SELF;
			sp->m_implicitTargetA[1] = EFF_TARGET_SELF;
			sp->m_implicitTargetA[2] = 0;
			sp->m_implicitTargetB[0] = 0;
			sp->m_implicitTargetB[1] = 0;
			sp->m_implicitTargetB[2] = 0;
	...
	// Insert mage spell fixes here
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 1 | 8192 | 4194304 | 8388608 | 262144 | 131072 | 536870912 | 524352 | 4 | 4096 | 2 | 2048 | 16;
			sp->m_effectItemType[1] = 1 | 8192 | 4194304 | 8388608 | 262144 | 131072 | 536870912 | 524352 | 4 | 4096 | 2 | 2048 | 16;
			sp->m_effectItemType[2] = 1 | 8192 | 4194304 | 8388608 | 262144 | 131072 | 536870912 | 524352 | 4 | 4096 | 2 | 2048 | 16;
		}
		...
		sp = dbcSpell.LookupEntryForced( 11213 );
		if( sp != NULL )
			sp->m_procTypeMask = PROC_ON_SPELL_HIT | PROC_TARGET_SELF;
		sp = dbcSpell.LookupEntryForced( 12574 );
		if( sp != NULL )
			sp->m_procTypeMask = PROC_ON_SPELL_HIT | PROC_TARGET_SELF;
		sp = dbcSpell.LookupEntryForced( 12575 );
		...
		if( sp != NULL )
		{
			sp->m_effectMiscValue[1] = 512;
			sp->m_effectMiscValue[1] = SMT_TRIGGER;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectMiscValue[0] = SMT_CRITICAL_DAMAGE;
			sp->m_effectAura[0] = SPELL_AURA_ADD_PCT_MODIFIER;
			sp->m_effectItemType[0] = 524288 | 131072 | 0 | 1 | 2 | 4 | 22 | 12 | 29 | 11;
			//sp->m_effectMiscValue[0] = 0xFFFFFFFF;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 524288 | 131072  ;
			sp->m_effectMiscValue[0] = 1;
		}
		sp = dbcSpell.LookupEntryForced( 12518 );
		if( sp != NULL )
		{
		...
		{
			sp->m_effectAura[0] = SPELL_AURA_ADD_PCT_MODIFIER;
			sp->m_effectItemType[0] = 8388608 | 2 | 16 | 4 | 1573376 | 524288 | 8 | 131072 | 262144 | 4194304 | 1 ;
			sp->m_effectMiscValue[0] = 64 | 128 | 1;
			sp->m_effectMiscValue[0] = SMT_COST;
		}
		...
		{
			sp->m_effectAura[1] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[1] = 36032;
			sp->m_procTypeMask = PROC_ON_CAST_SPECIFIC_SPELL;
		}
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = 8192;
		sp = dbcSpell.LookupEntryForced( 12606 );
		if( sp != NULL )
			sp->m_effectItemType[0] = 8192; //strange lvl 2 was working 
		...
		{
			sp->m_effectItemType[0] = 2097152;
			sp->m_effectBasePoints[0] *= 5; //heh B thinks he is smart by adding this to description ? If it doesn;t work std then it still needs to made by hand
			sp->m_effectItemType[1] = 2048;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 2097152; //damage
			sp->m_effectBasePoints[0] *= 5; //heh B thinks he is smart by adding this to description ? If it doesn;t work std then it still needs to made by hand
			sp->m_effectItemType[1] = 2048; //cost
		}
		...
		{    
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 12484;
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
		}
		...
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 12485;
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
		}
		...
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 12486;
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 8388608 | 16 | 2 | 4 | 8 | 262144 | 4194304 | 1;
			sp->m_effectItemType[1] = 8388608 | 16 | 2 | 4 | 8 | 262144 | 4194304 | 1;
		}
		...
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_CAST_SPELL | PROC_ON_SPELL_CRIT_HIT | PROC_TARGET_SELF;
			sp->m_procCharges = 0;
			sp->c_is_flags |= SPELL_FLAG_IS_REQUIRECOOLDOWNUPDATE;
		}
		sp = dbcSpell.LookupEntryForced( 28682 );
		if( sp != NULL )
			sp->m_effectItemType[0] = 8388608 | 16 | 2 | 4 | 4194304 | 1;
		...
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 29077;
			sp->m_procTypeMask = uint32(PROC_ON_SPELL_CRIT_HIT|PROC_TARGET_SELF);
			sp->m_procChance = 100;
		}
		...
		if( sp != NULL )
			sp->m_effectTriggerSpell[0] = 31643;
		...
		sp = dbcSpell.LookupEntryForced( 12472 ); 
		if( sp != NULL )
			sp->m_effectItemType[1] = 0xFFFFFFFF; // we can be sure this won't fuck up like Spell Power did, since it's 100%, not additive :P
		...
		if (sp!= NULL)
		{
			sp->m_effectItemType[0]= 0xFFFFFFFF;
			sp->m_effectMiscValue[0]= 0xFFFFFFFF;
		}
	...
	// Insert warlock spell fixes here
		...
		if (sp != NULL)
		{
			...
			sp->m_procTypeMask |= PROC_ON_MELEE_ATTACK_VICTIM | PROC_TARGET_SELF;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectAura[0] = SPELL_AURA_MOD_DAMAGE_DONE;
			sp->m_implicitTargetA[0] = EFF_TARGET_SELF;
			sp->m_effect[1] = 6;
			sp->m_effectAura[1] = SPELL_AURA_MOD_DAMAGE_DONE;
			sp->m_effectBasePoints[1] = sp->m_effectBasePoints[0];
			sp->m_implicitTargetA[1]= EFF_TARGET_PET;
			sp->m_effect[2] = SPELL_EFFECT_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[2] = 35696;
			sp->m_implicitTargetA[2]=EFF_TARGET_PET;
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_PET_OWNER | SPELL_FLAG_IS_EXPIREING_WITH_PET;
		}
		...
		if( sp != NULL )
		{
			sp->m_effect[0] = 6; //making this only for the visible effect
			sp->m_effectAura[0] = SPELL_AURA_DUMMY; //no effect here
			sp->m_implicitTargetA[0] = EFF_TARGET_PET;
		}
		...
		{
			sp->m_effectAura[1] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[1] = 27285;
			sp->m_procTypeMask = PROC_ON_SPELL_HIT_VICTIM | PROC_ON_DIE;
			sp->m_procChance = 100;
		}
		...
		if( sp != NULL )
		{
			...
			sp->m_effect[0]=SPELL_EFFECT_APPLY_AURA;
			sp->m_effectAura[0] = SPELL_AURA_SPLIT_DAMAGE;
			sp->m_effectMiscValue[0]=20;
			//sp->m_implicitTargetA[0] = EFF_TARGET_PET;
			//this is for the extra 5% dmg for caster and pet
			sp->m_effect[1] = 6;
			sp->m_effectAura[1] = 79;
			sp->m_effectBasePoints[1] = 4; //4+1=5
			sp->m_implicitTargetA[1] = EFF_TARGET_SELF;
			sp->m_implicitTargetB[1] = EFF_TARGET_PET;
			sp->c_is_flags |= SPELL_FLAG_IS_EXPIREING_WITH_PET;
		}
		...
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 17941;
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_procChance = 2;
		}
		sp = dbcSpell.LookupEntryForced( 18095 );
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 1024 | 2;
			sp->m_effectMiscValue[0] = 32784;
			sp->m_effectItemType[1] = 1024 | 2;
			sp->m_effectMiscValue[1] = 32784;
			sp->m_effectItemType[2] = 2 | 8 | 32768 | 2147483648UL | 1024 | 16384 | 262144UL | 16 | 524288UL | 4194304UL;
		}
		...
		{
			sp->m_effectItemType[0] = 2048;
			sp->m_effectMiscValue[0]=SMT_SPELL_VALUE_PCT;
			sp->m_effectBasePoints[0] = -(sp->m_effectBasePoints[0]+2);
			//sp->m_effectItemType[1] = 2048; //we do not handle this misc type yet anyway. Removed it just as a reminder
			sp->m_effectItemType[2] = 2048;
		}
		sp = dbcSpell.LookupEntryForced( 18822 );
		if( sp != NULL )
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 4 | 1 | 64 | 256 | 32 | 128 | 512; //destruction spells
			sp->m_effectMiscValue[0] = 64 | 128 |4096;
		}
		sp = dbcSpell.LookupEntryForced( 18131 );
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 4 | 1 | 64 | 256 | 32 | 128 | 512;
			sp->m_effectMiscValue[0] = 64 | 128 |4096;
		}
		sp = dbcSpell.LookupEntryForced( 18132 );
		if( sp != NULL )
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] =  2147483648UL | 4194304 | 1 | 2 | 16384 | 1024 | 8 | 262144 | 524288 | 2147483648UL | 16777216UL | 128 | 16 | 32768;
			sp->m_effectItemType[1] =  2147483648UL | 4194304 | 1 | 2 | 16384 | 1024 | 8 | 262144 | 524288 | 2147483648UL | 16777216UL | 128 | 16 | 32768;
		}
		sp = dbcSpell.LookupEntryForced( 18272 );
		if( sp != NULL )
		{
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 32 | 64 | 4 | 256 | 512;
			sp->m_effectMiscValue[0] = 64 | 128;
			sp->m_effectItemType[1] = 4;
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 1 | 4 | 32 | 64 | 128 | 256 | 512 ;
			sp->m_effectMiscValue[0] = 64 | 128 | 4096 ;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 1 | 4 | 32 | 64 | 128 | 256 | 512 ;
			sp->m_effectMiscValue[0] = 64 | 128 | 4096;
			sp->m_effectItemType[1] = 1 | 4 | 32 | 64 | 128 | 256 | 512 ;
			sp->m_effectMiscValue[1] = 64 | 128 | 4096 ;
		}
		sp = dbcSpell.LookupEntryForced( 17918 );
		if( sp != NULL )
		{
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = 2 | 8 | 32768 | 2147483648UL | 1024 | 16384 | 262144 | 16 | 524288 | 4194304; //affliction spell
		sp = dbcSpell.LookupEntryForced( 18175 );
		if( sp != NULL )
			sp->m_effectItemType[0] = 2 | 8 | 32768 | 2147483648UL | 1024 | 16384 | 262144 | 16 | 524288 | 4194304;
		...
		if( sp != NULL )
		{
			sp->m_effect[0] = 0; //disble this. This is just blizz crap. Pure proove that they suck :P
			sp->m_implicitTargetB[1] = EFF_TARGET_PET;
			sp->m_effectAura[2] = SPELL_AURA_MOD_SPELL_CRIT_CHANCE; //lvl 1 has it fucked up :O
			sp->m_implicitTargetB[2] = EFF_TARGET_PET;
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_PET_OWNER ;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectAura[1] = SPELL_AURA_MOD_DAMAGE_PERCENT_TAKEN;
			sp->m_implicitTargetA[1] = EFF_TARGET_PET;
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_PET_OWNER ;
		}
		...
		{
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_ON_PET ;
			sp->m_effectAura[0] = SPELL_AURA_MOD_PERCENT_STAT;
			sp->m_effectMiscValue[0] = 3;
			sp->m_implicitTargetA[0] = EFF_TARGET_PET;
		}
		sp = dbcSpell.LookupEntryForced( 18743 );
		if( sp != NULL )
		...
		if( sp != NULL )
		{
			...
			sp->m_effect[1] = SPELL_EFFECT_APPLY_AURA;
			sp->m_effectAura[1] = SPELL_AURA_MOD_DAMAGE_PERCENT_DONE;
			sp->m_implicitTargetA[1] = EFF_TARGET_PET;
			sp->m_effectMiscValue[1] = SCHOOL_NORMAL;
			sp->m_effectBasePoints[1] = sp->m_effectBasePoints[0] ;
		}
		...
		if( sp != NULL )
		{
			...
			sp->m_effect[0] = SPELL_EFFECT_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 23784;
		}
		...
		if( sp != NULL )
		{
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_ON_PET | SPELL_FLAG_IS_EXPIREING_WITH_PET;
			sp->m_effect[0] = SPELL_EFFECT_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 23830;
		}
		...
		if( sp != NULL )
		{
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_ON_PET | SPELL_FLAG_IS_EXPIREING_WITH_PET;
			sp->m_effect[0] = SPELL_EFFECT_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 23831;
		}
		...
		if( sp != NULL )
		{
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_ON_PET | SPELL_FLAG_IS_EXPIREING_WITH_PET;
			sp->m_effect[0] = SPELL_EFFECT_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 23832;
		}
		...
		if( sp != NULL )
		{
			sp->c_is_flags |= SPELL_FLAG_IS_CASTED_ON_PET_SUMMON_ON_PET | SPELL_FLAG_IS_EXPIREING_WITH_PET;
			sp->m_effect[0] = SPELL_EFFECT_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 35708;
		}
		//and the rest
		...
		if( sp != NULL )
		{
			sp->c_is_flags |= SPELL_FLAG_IS_EXPIREING_WITH_PET;
			sp->m_effect[0] = SPELL_EFFECT_APPLY_AURA;
			sp->m_effect[1] = 0; //hacks, we are handling this in another way
		}
		...
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_TARGET_DIE | PROC_TARGET_SELF;
			sp->m_procChance = 100;
			sp->m_effect[0] = SPELL_EFFECT_APPLY_AURA;
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 18371;
			sp->m_implicitTargetA[0] = EFF_TARGET_SELF;
			sp->m_effectItemType[1] = 2 | 8 | 32768 | 2147483648UL | 1024 | 16384 | 262144 | 16 | 524288 | 4194304;
			sp->m_effect[2] = 0 ; //remove this effect
		}
		...
		{
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_effect[1] = 0 ; //remove this effect ? Maybe remove the other one :P xD
		}
		...
		if( sp != NULL )
		{
			sp->m_effect[0] = 6; //aura
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 30294;
			sp->m_procTypeMask = uint32(PROC_ON_CAST_SPELL|PROC_TARGET_SELF);
		}
		...
		if( sp != NULL )
		{
			sp->m_effect[0] = 0; //delete this owerride effect :P
			sp->m_effectTriggerSpell[1] = 18093; //trigger spell was wrong :P
			sp->m_procTypeMask = PROC_ON_ANY_HOSTILE_ACTION;
			sp->m_procChance = 13; //god, save us from fixed values !
		}
		sp = dbcSpell.LookupEntryForced( 18096 );
		if( sp != NULL )
		{
			...
			sp->m_effectTriggerSpell[1] = 18093; //trigger spell was wrong :P
			sp->m_procTypeMask = PROC_ON_ANY_HOSTILE_ACTION;
			sp->m_procChance = 26; //god, save us from fixed values !
		}
	...
	// Insert druid spell fixes here
		...
		if ( sp != NULL )
		{
			sp->m_effect[1] = SPELL_EFFECT_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[1] = 24864;
		}
		sp = dbcSpell.LookupEntryForced( 24866 );
		if ( sp != NULL )
		{
			sp->m_effect[1] = SPELL_EFFECT_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[1] = 24867;
		}
		...
		{
			sp->m_effect[0] = 6;
			sp->m_effectAura[0] = SPELL_AURA_PERIODIC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 22845;
		}
		...
		{
			sp->m_effectItemType[0] = 2048;
			sp->m_effectMiscValue[0] = 1048576 | 64;
			sp->m_effectItemType[1] = 4096;
			sp->m_effectMiscValue[1] = 1024;
		}
		sp = dbcSpell.LookupEntryForced( 16935 ); 
		...
		{
			sp->m_effect[1] = 0;
			sp->m_effect[2] = 0; //removing strange effects.
		}

		// Druid: Control of Nature
		sp = dbcSpell.LookupEntryForced( 16918 );			// Rank 1
		sp->m_effectMiscValue[0] |= 0x20;
		...
		if( sp != NULL ) 
		{
			sp->m_effectMiscValue[0] |= 1024;
			//sp->m_effectMiscValue[1] |= 1024;
			//sp->m_effectMiscValue[2] |= 1024;
		}
		sp = dbcSpell.LookupEntryForced( 16999 );
		if( sp != NULL ) 
		{
		...
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 16953;
			sp->m_procTypeMask = PROC_ON_CRIT_ATTACK;
			sp->m_procChance = 100;
		}
		...
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 16959;
			sp->m_procTypeMask = PROC_ON_CRIT_ATTACK;
			sp->m_procChance = 100;
		}
		...
		if( sp != NULL )
		{
			sp->m_effect[0] = 6; 
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 339; 
			sp->m_effect[1] = 0; 
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK_VICTIM | PROC_REMOVEONUSE;
			sp->m_auraInterruptFlags = 0; //we remove it on proc or timeout
		}
		...
		if( sp != NULL )
		{
			sp->m_effect[0] = 6; 
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 1062; 
			sp->m_effect[1] = 0; 
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK_VICTIM | PROC_REMOVEONUSE;
			sp->m_auraInterruptFlags = 0; //we remove it on proc or timeout
		}
		...
		if( sp != NULL )
		{
			sp->m_effect[0] = 6; 
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 5195; 
			sp->m_effect[1] = 0; 
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK_VICTIM | PROC_REMOVEONUSE;
			sp->m_auraInterruptFlags = 0; //we remove it on proc or timeout
		}
		...
		if( sp != NULL )
		{
			sp->m_effect[0] = 6; 
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 5196; 
			sp->m_effect[1] = 0; 
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK_VICTIM | PROC_REMOVEONUSE;
			sp->m_auraInterruptFlags = 0; //we remove it on proc or timeout
		}
		...
		if( sp != NULL )
		{
			sp->m_effect[0] = 6; 
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 9852; 
			sp->m_effect[1] = 0; 
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK_VICTIM | PROC_REMOVEONUSE;
			sp->m_auraInterruptFlags = 0; //we remove it on proc or timeout
		}
		...
		if( sp != NULL )
		{
			sp->m_effect[0] = 6; 
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 9853; 
			sp->m_effect[1] = 0; 
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK_VICTIM | PROC_REMOVEONUSE;
			sp->m_auraInterruptFlags = 0; //we remove it on proc or timeout
		}
		...
		if( sp != NULL )
		{
			sp->m_effect[0] = 6; 
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 26989; 
			sp->m_effect[1] = 0; 
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK_VICTIM | PROC_REMOVEONUSE;
			sp->m_auraInterruptFlags = 0; //we remove it on proc or timeout
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[2] = 32 | 64 | 16; //for the mana cost tweak
			sp->m_effectMiscValue[2] = 2 | 4096 | 128 | 524288 ;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 268435456 | 32 | 64 | 16 | 128 | 268435456;
			sp->m_effectMiscValue[0] |= 16;
			sp->m_effectItemType[1] = 268435456 | 32 | 64 | 16 | 128 | 268435456;
			sp->m_effectMiscValue[1] |= 16;
		}
		sp = dbcSpell.LookupEntryForced( 24943 );
		if( sp != NULL )
		{
		...
		if( sp != NULL )
			sp->m_effectItemType[0] = 64 | 16 | 128;
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 0xFFFFFFFF; //all spells, too bad not all spells have grouping flags :S
			sp->m_procCharges = 1;
		}
		...
		if( sp != NULL )
		{
			sp->m_procChance=100; //procchance dynamic. 3ppm
			sp->m_procTypeMask = PROC_ON_MELEE_ATTACK | PROC_ON_CRIT_ATTACK;
		}
		uint32 mm = (1<<(FORM_BEAR-1))|(1<<(FORM_DIREBEAR-1))|(1<<(FORM_MOONKIN-1))|(1<<(FORM_CAT-1));

		sp = dbcSpell.LookupEntryForced( 16972 );
		if( sp != NULL )
			sp->m_shapeshiftMask = mm;
	...
	// Insert items spell fixes here
		...
		if (sp != NULL)
			sp->m_effectMiscValue[0]=64 | 1024;
		...
		if (sp != NULL)
			sp->m_effectItemType[0]= 1048576 |268435456 | 2147483648;
		...
		{
			sp->m_effectItemType[0]= 1073741824;
			sp->m_effectItemType[1]= 2147483648;
		}
		...
		if( sp != NULL )
		{
			sp->m_effect[0] = SPELL_EFFECT_DUMMY;
		}
		...
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 43740;
		}
		...
		if( sp != NULL )
		{
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 37198;
			sp->m_procChance = 15;
		}
		...
		{
			sp->m_effect[2] = SPELL_EFFECT_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[2] = 27648;
			sp->m_implicitTargetA[2] = EFF_TARGET_SELF;
		}
		...
		if( sp != NULL )
		{
			...
			sp->m_procChance = 40;
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_effectTriggerSpell[0] = 40452;
			sp->m_cumulativeAura = 1;
			sp->m_effect[1] = 6;
			sp->m_effectAura[1] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_procChance = 25;
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_effectTriggerSpell[1] = 40445;
			sp->m_cumulativeAura = 1;
			sp->m_effect[2] = 6;
			sp->m_effectAura[2] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_procChance = 25;
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_effectTriggerSpell[2] = 40446;
			sp->m_cumulativeAura = 1;
		}
		...
		if( sp != NULL )
		{
			...
			sp->m_procChance = 10;
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_effectTriggerSpell[0] = 40441;
			sp->m_cumulativeAura = 1;
			sp->m_effect[1] = 6;
			sp->m_effectAura[1] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_procChance = 10;
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_effectTriggerSpell[1] = 40440;
			sp->m_cumulativeAura = 1;
		}
		...
		if( sp != NULL )
		{
			sp->m_implicitTargetA[0] = EFF_TARGET_ALL_ENEMIES_AROUND_CASTER;
			sp->m_implicitTargetA[1] = EFF_TARGET_ALL_ENEMIES_AROUND_CASTER;
			sp->m_implicitTargetA[2] = 0;
			sp->m_implicitTargetB[0] = 0;
			sp->m_implicitTargetB[1] = 0;
			sp->m_implicitTargetB[2] = 0;
		...
		if( sp != NULL )
		{
			...
			sp->m_procChance = 20;
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_effectTriggerSpell[0] = 40461;
			sp->m_cumulativeAura = 1;
		}
	#else
		sp = dbcSpell.LookupEntryForced( 40460 );
		...
		if( sp != NULL )
		{
			...
			sp->m_procChance = 100;
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->m_effectTriggerSpell[0] = 37445;
			sp->m_cumulativeAura = 1;
		}
		...
		{
			sp->m_effectMiscValue[0] |=1024;
			sp->m_effectMiscValue[1] |=64;
		}
		sp = dbcSpell.LookupEntryForced( 38416 );
		if( sp != NULL )
		{
			sp->m_effectItemType[0] |=8388608;
			sp->m_effectMiscValue[0] |=1048576;
			sp->m_effectItemType[1] |=8388608;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectMiscValue[0] |= 2 | 4;
			sp->m_effectItemType[0] |= 8388612 |8388610 |41943040;
		}
		...
		{
			sp->m_procChance = 15;
			//sp->m_procTypeMask = PROC_ON_CAST_SPELL; Need new flag - PROC_ON_FINISH_MOVE;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 1572896 | 1 | 2048;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 1572896 | 1;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectMiscValue[0] = 32;
			sp->m_effectMiscValue[1] = 64;
			//sp->m_effectMiscValue[2] = 64; NEED DBC 2.3.2 :P
		}
		...
		if( sp != NULL )
		{
			...
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->proc_interval = 20;
			sp->m_effectTriggerSpell[0] = 37379;
		}
		...
		if( sp != NULL )
		{
			...
			sp->m_procTypeMask = PROC_ON_CAST_SPELL;
			sp->proc_interval = 20;
			sp->m_effectTriggerSpell[0] = 37378;
		}
		sp = dbcSpell.LookupEntryForced( 37380 );
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 2|4;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 1048576 | 268435456 | 2147483648UL;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 536870912UL;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 1024 | 524288 | 1048576 | 536870912UL;
			sp->m_effectMiscValue[0] = 1|520;
		}
		...
		if( sp != NULL )
		{
			sp->m_effectItemType[0] = 33554432UL;
			sp->m_effectMiscValue[0] = 1024;
		}
		...
		if( sp != NULL )
		{
			sp->m_procChance = 30;//some say it is triggered every now and then
			sp->m_procTypeMask = PROC_ON_RANGED_ATTACK;
		}
		...
		{
			sp->m_reagent[1] = 0;
			sp->m_reagentCount[1] = 0;
			sp->m_effectItemType[0] = 23248;
			sp->m_effect[0] = 24;
		}
		...
		{
			sp->m_effectAura[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
			sp->m_effectTriggerSpell[0] = 37515;
			sp->m_procChance = 25;
		}
	...
	// Insert Death Knight spell fixes here
			
			// All Presences: only one on a target
			sp = dbcSpell.LookupEntryForced( 48266 ); // Blood Presence
			if( sp != NULL )
			{
				sp->buffType |= SPELL_TYPE_DK_PRESENCE;
				sp->c_is_flags |= SPELL_FLAG_IS_FORCEDBUFF;
			}
			sp = dbcSpell.LookupEntryForced( 48265 ); // Unholy Presence
			if( sp != NULL )
				sp->buffType |= SPELL_TYPE_DK_PRESENCE;
			sp = dbcSpell.LookupEntryForced( 48263 ); // Frost Presence
			if( sp != NULL )
				sp->buffType |= SPELL_TYPE_DK_PRESENCE;
